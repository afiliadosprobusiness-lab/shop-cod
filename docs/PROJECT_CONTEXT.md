...
- La UI del page builder se alineo a un estilo light-builder (inspirado en Lightfunnels): topbar clara, quick-tools rail vertical, paneles claros y canvas tipo x-ray.
